      ...
      <div className="w-full max-w-md backdrop-blur-xl rounded-3xl shadow-2xl shadow-black/50 p-8 md:p-10 z-10 glass-card">
        ...
        <div className="text-center mb-10">
          ...
          <h2 className="text-3xl font-extrabold text-transparent bg-clip-text bg-gradient-to-r from-teal-400 to-emerald-300 tracking-tight">
            Welcome Back <Sparkles className="w-5 h-5 text-teal-400 inline mb-1" />
          </h2>
          <p className="mt-3 text-slate-400 font-medium">Sign in to continue to ChatPulse</p>
        </div>
        ...
        <div className="mt-8 text-center pt-6">
          <p className="text-slate-400 text-sm font-medium">
            New to ChatPulse?{' '}
            <Link to="/register" className="text-teal-400 hover:text-teal-300 font-semibold transition-colors ml-1">
              Create an Account
            </Link>
          </p>
        </div>
