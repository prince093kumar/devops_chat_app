      ...
      <div className="w-full max-w-md bg-slate-900/40 backdrop-blur-2xl border border-slate-800/80 hover:border-indigo-500/20 transition-all duration-500 rounded-3xl shadow-2xl p-8 md:p-10 relative z-10 group">
        ...
        <div className="text-center mb-8">
          ...
          <h2 className="text-3xl font-extrabold tracking-tight bg-gradient-to-r from-indigo-200 via-purple-300 to-pink-300 bg-clip-text text-transparent flex items-center justify-center gap-2">
            ChatPulse <Sparkles className="w-5 h-5 text-indigo-400 animate-pulse" />
          </h2>
          <p className="text-slate-400 mt-2 text-xs font-semibold uppercase tracking-wider">ENTERPRISE CHAT WORKSPACE</p>
        </div>
        ...
        <form onSubmit={handleSubmit} className="space-y-6">
          ...
          {/* Email / Username */}
          <div>
            <label className="block text-slate-300 text-xs font-bold mb-2 uppercase tracking-wide">Username or Email</label>
        ...
        <div className="mt-8 text-center border-t border-slate-800/60 pt-6">
          <p className="text-slate-400 text-xs font-medium">
            New to ChatPulse?{' '}
            <Link to="/register" className="text-indigo-400 hover:text-indigo-300 font-bold transition-all ml-1 underline decoration-indigo-500/30 hover:decoration-indigo-500">
              Create an Account
            </Link>
          </p>
        </div>
