...
const Register = () => {
  ...
  return (
    ...
    >
      ...
      <div className="absolute top-1/4 right-1/4 w-[400px] h-[400px] bg-violet-600/20 rounded-full blur-[120px] mix-blend-screen animate-pulse pointer-events-none"></div>
      <div className="absolute bottom-1/4 left-1/4 w-[300px] h-[300px] bg-blue-600/20 rounded-full blur-[100px] mix-blend-screen animate-pulse pointer-events-none" style={{ animationDelay: '2s' }}></div>

      {/* Main Glassmorphic Wrapper */}
      <div className="w-full max-w-md backdrop-blur-3xl rounded-3xl shadow-2xl shadow-black/50 p-8 md:p-10 z-10 glass-card mt-8 mb-8">
        ...
        <div className="text-center mb-8">
          ...
          <h2 className="text-3xl font-bold tracking-tight text-slate-100 flex items-center justify-center gap-2">
            Create Account <Sparkles className="w-5 h-5 text-violet-400" />
          </h2>
          <p className="text-slate-400 mt-2 text-sm font-medium">Join the ChatPulse workspace</p>
        </div>
        ...
        <form onSubmit={handleSubmit} className="space-y-5">
          ...
          <div>
            ...
            <div className="relative group/input">
              <User className="absolute left-4 top-1/2 -translate-y-1/2 w-4.5 h-4.5 text-slate-500 group-focus-within/input:text-violet-400 transition-colors" />
              <input
                type="text"
                value={username}
